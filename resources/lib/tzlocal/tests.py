...
class TzLocalTests(unittest.TestCase):
    ...
    def test_timezone(self):
        ...
        tz = tzlocal.unix._get_localzone(
            _root=os.path.join(self.path, 'test_data', 'timezone'))
    ...
    def test_zone_setting(self):
        ...
        tz = tzlocal.unix._get_localzone(
            _root=os.path.join(self.path, 'test_data', 'zone_setting'))
        self.assertEqual(tz.zone, 'Africa/Harare')
    ...
    def test_timezone_setting(self):
        ...
        tz = tzlocal.unix._get_localzone(
            _root=os.path.join(self.path, 'test_data', 'timezone_setting'))
        self.assertEqual(tz.zone, 'Africa/Harare')
    ...
    def test_symlink_localtime(self):
        ...
        tz = tzlocal.unix._get_localzone(
            _root=os.path.join(self.path, 'test_data', 'symlink_localtime'))
        self.assertEqual(tz.zone, 'Africa/Harare')
    ...
    def test_vardbzoneinfo_setting(self):
        ...
        tz = tzlocal.unix._get_localzone(
            _root=os.path.join(self.path, 'test_data', 'vardbzoneinfo'))
        self.assertEqual(tz.zone, 'Africa/Harare')
