...
def get_token():
    ...
    if addon.getSetting('rmcbfmplay.login') == '' or \
        addon.getSetting('rmcbfmplay.password') == '':

        xbmcgui.Dialog().ok(
            addon.getLocalizedString(30600),
            addon.getLocalizedString(30604) % ('RMCBFMPlay', 'https://www.rmcbfmplay.com'))
        return False
    ...
    headers = {"secret": "Basic Uk1DQkZNUGxheUFuZHJvaWR2MTptb2ViaXVzMTk3MA==",
