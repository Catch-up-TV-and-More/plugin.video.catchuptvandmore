...
def get_live_url(plugin, item_id, **kwargs):
    ...
    resp = requests.get(f"https://dsh-m013.ora02.live-scy.canalplus-cdn.net/plfiles/v2/metr/dash-ssl/{item_id}-hd.json?device=PC&route=scy-ora02&edge=routemeup.canalplus-bo.net").json()
