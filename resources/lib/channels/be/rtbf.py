...
def get_drm_item(plugin, video_id, video_url, url_token_parameter):
    ...
    license_url = URL_LICENCE_KEY % urlencode(headers)
    input_stream_properties = {"manifest_update_parameter": 'full'}
    return get_stream_with_quality(plugin, video_url=video_url, manifest_type='mpd', license_url=license_url, input_stream_properties=input_stream_properties)
